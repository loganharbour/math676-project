...
\begin{frame}\frametitle{Diffusion Acceleration Results}
	Consider $\spatial = [0, 10]^2$, $N_\Omega = 20$, $q = 1$, $\sigma_a + \sigma_s = \sigma_t = 100$, and $16^2$ elements. Increase the scattering ratio, $\sigma_s / \sigma_t$ with and without diffusion acceleration and observe the results:
	\vfill
